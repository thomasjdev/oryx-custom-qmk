...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_EQUAL,                                       KC_EQUAL,       KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           TD(DANCE_0),    
    ...
    MO(3),          LGUI(LSFT(KC_4)),KC_LEFT_CTRL,   KC_LEFT_ALT,    KC_LEFT_GUI,    LGUI(KC_SPACE),                                                                                                 LCTL(KC_SPACE), MO(1),          KC_LEFT_GUI,    KC_LEFT_ALT,    KC_LEFT_CTRL,   MO(3),          
    KC_BSPC,        LT(2,KC_DELETE),LGUI(LSFT(KC_SPACE)),                LGUI(LCTL(KC_EQUAL)),LT(2,KC_ENTER), KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, LGUI(KC_LBRC),  LGUI(KC_RBRC),  KC_TRANSPARENT, KC_TRANSPARENT, KC_PAGE_UP,                                     KC_HOME,        KC_TRANSPARENT, KC_TRANSPARENT, LGUI(LSFT(KC_LBRC)),LGUI(LSFT(KC_RBRC)),KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [1] = { {169,120,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {219,255,255}, {234,255,255}, {74,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {74,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {0,245,245}, {0,245,245}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {41,255,255}, {146,224,255}, {234,255,255}, {234,255,255}, {234,255,255}, {41,255,255}, {146,224,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {146,224,255}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255}, {146,224,255}, {234,255,255}, {234,255,255}, {0,245,245}, {0,245,245}, {234,255,255}, {234,255,255}, {234,255,255}, {234,255,255} },
